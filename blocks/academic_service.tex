...
\begin{itemize}
    ...
    \item \textbf{Guest Editor} of the Special Issue on ``Methods and Algorithms for Autonomous Systems in Intelligent Transportation'', IEEE Open Journal of Intelligent Transportation Systems, from August 2026
\end{itemize}
...
\begin{enumerate}
    ...
    \item Invited talk at the Workshop ``An Introduction to Autoware and Its Application Platforms'', IEEE 29th International Conference on Intelligent Transportation Systems (ITSC), Naples, Italy: \textit{Differentiable Learning for Planning and Control: From Small-Scale to Full-Scale Autonomous Vehicles with Autoware}, 2026
