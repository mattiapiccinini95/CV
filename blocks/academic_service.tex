...
\begin{itemize}
    ...
    \item \textbf{Guest Editor} of the Special Issue on ``Methods and Algorithms for Autonomous Systems in Intelligent Transportation'', IEEE Open Journal of Intelligent Transportation Systems, from June 2026
\end{itemize}
...
% \begin{itemize}
%     \item IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) 2020, Las Vegas (USA) (virtual attendance due to COVID-19)
