...
\DeclareBibliographyCategory{invitedtalks}
\DeclareBibliographyCategory{postersessions}
\addtocategory{invitedtalks}{TalkTUE_2025,TalkVerona_2026,UniBwTalk2022,EKUMENTalk2025,TUMTalk2024,ModelySeminar2024}
\addtocategory{postersessions}{Poster2022,Poster2022b,Poster2023,ICRA_poster_2025}
...
\input{blocks/publications}
\makerubric{blocks/awards}
\makerubric{blocks/projects}
\input{blocks/academic_service}
\vspace{0.05cm}
\makerubric{blocks/skills}
\input{blocks/personal_interests}
\input{blocks/referee}
\input{blocks/place_and_date}
